...
export declare class StudentInstructorService {
    ...
    constructor(dataSource: DataSource, studentInstructorRepository: Repository<StudentInstructor>, studentRepository: Repository<Student>, instructorRepository: Repository<Instructor>);
